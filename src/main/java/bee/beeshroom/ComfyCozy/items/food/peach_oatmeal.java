...
public class peach_oatmeal  extends ItemFood
{
	public peach_oatmeal(String name, int amount, float saturation, boolean isWolfFood) 
	{
	 ...
	 @Override
		public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) 
		{
			...
			{
				worldIn.setBlockState(pos.up(), ModBlocks.BOWL_PEACH.getDefaultState());
