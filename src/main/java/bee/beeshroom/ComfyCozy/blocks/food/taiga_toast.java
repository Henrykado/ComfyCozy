...
public class taiga_toast extends BlockBase 
{
	 ...
	 public static final PropertyInteger BITES = PropertyInteger.create("bites", 0, 1);
	    protected static final AxisAlignedBB[] CAKE_AABB = new AxisAlignedBB[] 
	    	   {new AxisAlignedBB(0.1875D, 0.0D, 0.1875D, 0.8125D, 0.20D, 0.8125D),
	    		   new AxisAlignedBB(0.1875D, 0.0D, 0.1875D, 0.8125D, 0.20D, 0.8125D),
	    		   new AxisAlignedBB(0.1875D, 0.0D, 0.1875D, 0.8125D, 0.20D, 0.8125D)};

	    public taiga_toast(String name, Material material)
	    {
	    	super(name, material);
	    ...
	    private boolean eatCake(World worldIn, BlockPos pos, IBlockState state, EntityPlayer player)
	    {
	        ...
	        else
	        {
	            ...
	            player.getFoodStats().addStats(6, 0.4F);
	    ...
	    {
	        return new ItemStack(ModBlocks.TAIGA_TOAST);
	    }
