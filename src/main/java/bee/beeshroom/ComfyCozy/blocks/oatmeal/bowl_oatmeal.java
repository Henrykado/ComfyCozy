package bee.beeshroom.ComfyCozy.blocks.oatmeal;
...
public class bowl_oatmeal extends BlockBase 
{
	...
	public static final AxisAlignedBB BOWL = new AxisAlignedBB(0.3125D, 0.0D, 0.3125D, 0.6875D, 0.12D, 0.6875D);
	    ...
	    public bowl_oatmeal(String name, Material material) 
	    {
		super(name, material);
	...
	/*    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
	    ...
	    private void spawnParticles(World worldIn, BlockPos pos, IBlockState state)
	    {
	    	...
	    	// Random random = worldIn.rand;
	            ...
	            if (i < 1)
	    	{//+ random.nextFloat()), v
	            	   worldIn.spawnParticle(EnumParticleTypes.EXPLOSION_NORMAL, (double)((float)pos.getX()), (double)((float)pos.getY()), (double)((float)pos.getZ()), 0.0D, 0.0D, 0.0D);
        }}
