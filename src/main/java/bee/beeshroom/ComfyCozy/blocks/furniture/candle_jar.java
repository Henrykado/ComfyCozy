...
public class candle_jar extends BlockDirectional
{
...
//    public static final AxisAlignedBB BUNTING_VERT = new AxisAlignedBB(0.4375D, 0D, 0.4375D, 0.5625D, 1D, 0.5625D);
	...
	public static final AxisAlignedBB BUNTING_WE = new AxisAlignedBB(0.25D, 0.0625D, 0.1875D, 0.75D, 0.9000000238418579D, 0.8125D);
	public static final AxisAlignedBB BUNTING = new AxisAlignedBB(0.25D, 0.0625D, 0.1875D, 0.75D, 0.9000000238418579D, 0.8125D);
	//public static final AxisAlignedBB BUNTING_WE = new AxisAlignedBB(0.3125D, 0.20000000298023224D, 0.625D, 0.6875D, 0.800000011920929D, 1.0D);
 //  public static final AxisAlignedBB BUNTING = new AxisAlignedBB(0.3125D, 0.20000000298023224D, 0.625D, 0.6875D, 0.800000011920929D, 1.0D);
    public static final AxisAlignedBB BUNTING_VERT = new AxisAlignedBB(0.25D, 0.0D, 0.25D, 0.75D, 0.6000000238418579D, 0.75D);


    
	    public candle_jar(String name, Material material) 
	    {
		super(material);
