...
public class bunting_check extends BlockHorizontal
{
...
//    public static final AxisAlignedBB BUNTING_VERT = new AxisAlignedBB(0.4375D, 0D, 0.4375D, 0.5625D, 1D, 0.5625D);
   ...
   // public static final AxisAlignedBB BUNTING_VERT = new AxisAlignedBB(0.4375D, 0D, 0.4375D, 0.5625D, 1D, 0.5625D);
	    ...
	    public bunting_check(String name, Material material) 
	    {
		super(material);
...
/*
	    ...
	    {
	        return this.getDefaultState().withProperty(FACING, EnumFacing.byHorizontalIndex(meta)).withProperty(LONG, Boolean.valueOf((meta & 4) != 0));
	    }
