...
//this code is copied directly from another mod i made where this code worked fine.
	...
	public boolean canPlaceBlockAt(World worldIn, BlockPos pos)
  {
	...
	/*	@Override
	    ...
	    {
	        return this.getDefaultState().withProperty(FACING, EnumFacing.byHorizontalIndex(meta & 3)).withProperty(MODE, Integer.valueOf((meta & 15) >> 2));
	    }
	...
	/*    public IBlockState getStateFromMeta(int meta)
	    {
	        return this.getDefaultState().withProperty(FACING, EnumFacing.byHorizontalIndex(meta)).withProperty(MODE, Integer.valueOf((meta & 15) >> 9));
	    }
	    public int getMetaFromState(IBlockState state)
	    {
	        int i = 0;
