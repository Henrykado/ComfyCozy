...
public class TileEntityBrickFurnace extends TileEntityLockable implements ITickable, ISidedInventory
{
	    ...
	    {
	        return ConfigHandler.BRICK_FURNACE_COOKTIME; // 1 coal = 10 items (with the longer fuel times [set in getItemBurnTime], 12)
	    }
		   ...
		   */
		    ...
		    {
		    	return (int)(TileEntityFurnace.getItemBurnTime(stack) * ConfigHandler.BRICK_FURNACE_FUELMULTIPLIER);
		    }
